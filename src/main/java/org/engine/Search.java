...
public final class Search {
	...
	private int negamax(long[] board, int depth, int ply, int alpha, int beta, NodeType nodeType) {
		...
		MovePicker picker = new MovePicker(board, pos, moveGen, moves, ttMoveForNode, killer, false, inCheck);
	...
	private int quiescence(long[] board, int ply, int alpha, int beta, NodeType nodeType) {
		...
		MovePicker picker = new MovePicker(board, pos, moveGen, moves, ttMoveForQ, MoveFactory.MOVE_NONE, true, inCheck);

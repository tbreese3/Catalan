...
NMPDepthScale100, int, 25.0, 0.0, 200.0, 2.0, 0.005
NMPEvalMargin, int, 200.0, 1.0, 4000.0, 50.0, 0.003
NMPEvalMax, int, 3.0, 0.0, 10.0, 0.5, 0.005
LMRBase100, int, 75.0, 0.0, 300.0, 5.0, 0.003
...
public final class SPSA {
    public double lmrBase = 0.75;
    public double lmrDivisor = 2.25;
    public int futilityMaxDepth = 3;
    public int futilityMarginPerDepth = 128;
    public int qseeMargin = 0;
    public int nmpBase = 2;
    public double nmpDepthScale = 0.25;
    public int nmpEvalMargin = 200;
    public int nmpEvalMax = 3;
